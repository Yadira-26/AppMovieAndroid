...
android {
    namespace = "com.example.appandroidmovie"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.appandroidmovie"
        minSdk = 34
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("io.ktor:ktor-client-android:2.3.9") // Específico para Android
